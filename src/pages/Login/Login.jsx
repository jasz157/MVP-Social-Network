        ...
        <>
            ...
            <Wrapper>
                <FormContentWrapper>
                    ...
                    <StyledButton onClick={(e) => { e.preventDefault(); window.location.replace('/feed') }}>Login</StyledButton>

                    <a href='/forgotPassword' className="pageAnchor">Esqueceu a senha ?</a>
                    <a href='/signup' className="pageAnchor">Não e usuario ?...Cadastre-se</a>
                </FormContentWrapper>
            </Wrapper>
